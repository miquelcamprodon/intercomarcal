...
def carregarfitxer(request):
    ...
    for row in cr:
        ...
        #queryList.append([str(row[0]),float(row[1])])
    ...
    query = "INSERT INTO cities (" + queryfields + ") VALUES (" + queryvalues + ");"
    ...
    return render_to_response('programa/cities.html',{'bb':query},context_instance=RequestContext(request))