...
def ranquingtti(request):
    ...
    return render_to_response('programa/ranquingtti.html',
...
def carregarfitxer(request):
    ...
    return render_to_response('programa/carregarranquing.html',{'bb':queryList[0]},context_instance=RequestContext(request))